...
----------------------------------------------------------------------------------------------------
npx create-react-app client inside server directory
install concurrently or npm-run-all to allow run both client and server together using single run-p server client command
